...
<body>
 <div id="content"> <!-- Content start -->
                ...
                <div class="row-fluid">
                    <div class="span12">
                         <div  class="daohanglink"style="">
                           ...
                           <span>客户需求管理</span>
                          <a href="${ctx}/need_addNeed.do" class="label label-warning" style="float:right; margin:8px;">添加</a> 
                         </div>
                        <div class="well brown">
                            <div class="well-content" style="border:0px;">
                                <table class="table table-striped table-bordered table-hover datatable">
                                    ...
                                    <tbody>
                                     <c:forEach items="${pagers.datas}" var="need" varStatus="l">
                                        <tr>
                                            <td align="center">${need.id}</td>
                                             ...
                                             <td>${need.remark}</td>
                                            <td>
                                            <a class="btn"  href="${ctx}/need_delNeed.do?needId=${need.id}" title="删除"><i class="icon-trash"></i></a>
                                            <a class="btn" href="${ctx}/need_updateNeed.do?needId=${need.id}" title="修改"><i class="icon-inbox"></i></a>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
      ...
      <pg:pager  url="${ctx}/need_needList.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
