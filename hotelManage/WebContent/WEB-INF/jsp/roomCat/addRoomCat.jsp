 ...
 <div id="content"> <!-- Content start -->
	...
	private int num;//剩余数-->
                        ...
                        <div class="well brown">
                         <form action="roomCat_roomAddCat.do"  method="post" enctype="multipart/form-data">
                            <div class="form_list"><label class="lable_title">类型名称&nbsp;&nbsp;&nbsp;&nbsp;</label>
                            <input class="form_input" name="roomCatName" type="text"/>
                            </div>
                            <div class="form_list"><label class="lable_title">客房类型&nbsp;&nbsp;&nbsp;&nbsp;</label>
                            <input class="form_input" name="type" type="text"/>
                            </div>
                           ...
                           <input class="form_input" type="file" name="file" id="" ></div>
                            ...
                            <input class="form_input" name="num" type="text"/>
                            </div>
