...
<%--                                          <div>状态：<c:if test="${book.bookUser.isDelete == 1 }">  --%>
<!-- 								                                              已刪除  -->
<%--  								               </c:if>  --%>
<%-- 								               <c:if test="${book.bookUser.isDelete == 2 }"> --%>
<!-- 								                                               未刪除  -->
<%--  								               </c:if></div> --%>
 								              ...
 								              <c:if test="${book.status == 1 }">
								                  <div class="label label-warning"  style="margin-left: 218px; cursor: pointer;"> <a  href="${ctx}/book_cancelBook.do?bookId=${book.id}"><span >取消预定</span></a></div>
<!-- 								               <div class="label label-warning" onclick="live()" style="margin-left: 50px; cursor: pointer;"><span >立即入住</span></div> -->
								               </c:if>
