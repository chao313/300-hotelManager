...
<body>
 <div id="content"> <!-- Content start -->
                                     ...
                                     <c:forEach items="${pagers.datas}" var="book" varStatus="l">
                                        <tr>
							               ...
							               <c:if test="${book.status == 2}">
                                                ...
                                                <td>
                                            <a class="btn" href="${ctx}/book_updateBook.do?bookId=${book.id}" title="查看"><i class="icon-inbox"></i></a>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
      ...
      <pg:pager  url="${ctx}/book_bookList.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
