                        ...
                        <div class="well brown">
                            ...
                            <div >
                                         ...
                                         <div>离店时间：<fmt:formatDate value="${book.leaveTime}" pattern="yyyy-MM-dd HH:mm:ss"/></div>
								               ...
								               <c:if test="${book.status == 2 }">
<%-- 								                <a class="btn" href="${ctx}/book_changeRoom.do?bookId=${book.id}"></a> --%>
								                <div class="label label-warning"  style="margin-left: 218px; cursor: pointer;"> <a  href="${ctx}/book_roomChange.do?bookId=${book.id}"><span >更换房间</span></a></div>
								               </c:if>
