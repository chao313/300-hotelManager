...
<body>
 <div id="content"> <!-- Content start -->
	...
	private int isRepair;//是否修理0：未修理 1.已修理
     -->
                          <a href="${ctx}/buy_addBuy.do" class="label label-warning" style="float:right; margin:8px;">添加</a> 
                         </div>
                        <div class="well brown">
                            <div class="well-content" style="border:0px;">
                                <table class="table table-striped table-bordered table-hover datatable">
                                    ...
                                    <tbody>
                                     <c:forEach items="${pagers.datas}" var="buy" varStatus="l">
                                        <tr>
                                            ...
                                            <td>￥${buy.price}</td>
                                             ...
                                             <td>${buy.remark}</td>
                                            <td>
<%--                                             <a class="btn"  href="${ctx}/buy_delBuy.do?buyId=${buy.id}" title="删除"><i class="icon-trash"></i></a> --%>
                                            <a class="btn" href="${ctx}/buy_updateBuy.do?buyId=${buy.id}" title="修改"><i class="icon-inbox"></i></a>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
      ...
      <pg:pager  url="${ctx}/buy_buyList.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
