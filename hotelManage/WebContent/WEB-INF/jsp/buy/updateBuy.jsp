                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <div class="well brown">
                         <form action="buy_buyUpdate.do"  method="post">
                            <div class="form_list"><label class="lable_title">物品名称</label>
                            <input class="form_input" name="name" type="text" value="${buy.name}"/></div>
                                <input type="hidden" name="id"  value="${buy.id}"/>
                            <div class="form_list"><label class="lable_title">物品价格</label>
                            <input class="form_input" name="price" type="text" value="${buy.price}"/></div>
                            <div class="form_list"><label class="lable_title">物品数量</label>
                            <input class="form_input" name="num" type="text" value="${buy.num}"/></div>
                             <div class="form_list"><label class="lable_title">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注</label>
                             <input class="form_input" name="remark" type="text" value="${buy.remark}"/></div>
