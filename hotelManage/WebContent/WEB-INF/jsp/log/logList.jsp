...
<body>
 <div id="content"> <!-- Content start -->
                ...
                <div class="row-fluid">
                    <div class="span12">
                         <div  class="daohanglink"style="">
                           ...
                           <span>日志管理</span>
                          <a href="${ctx}/log_addLog.do" class="label label-warning" style="float:right; margin:8px;">添加</a> 
                         </div>
                                ...
                                <table class="table table-striped table-bordered table-hover datatable">
                                    <thead>
                                        <tr>
                                            <th width="15%">序号</th>
                                            <th width="30%">日志内容</th>
                                            <th width="15%">日志操作人</th>
                                            <th width="20%">操作时间</th>
                                            <th width="20%">管理操作</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                     <c:forEach items="${pagers.datas}" var="log" varStatus="l">
                                        <tr>
                                             <td align="center">${l.index+1}</td>
                                            <td >${log.content}</td>
                                            <td >${log.manageUser.name}</td>
                                             <td ><fmt:formatDate value="${log.createTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                            <td>
                                            <a class="btn" href="${ctx}/log_updateLog.do?logId=${log.id}" title="修改"><i class="icon-inbox"></i></a>
                                            <a class="btn"  href="${ctx}/log_delLog.do?logId=${log.id}" title="删除"><i class="icon-trash"></i></a>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
      ...
      <pg:pager  url="${ctx}/log_logList.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
