 ...
 <div id="content"> <!-- Content start -->
	...
	private Date createTime; //创建时间 -->
                        ...
                        <div class="well brown">
                         <form action="manage_addManage.do"  method="post">
                            <div class="form_list"><label class="lable_title">账号名称</label><input class="form_input" name="name" type="text"/></div>
                             <div class="form_list"><label class="lable_title">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码</label><input class="form_input" name="passWord" type="text"/></div>
                            <div class="form_list"><label class="lable_title">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱</label><input class="form_input" type="text" name="email"/></div>
                            <div class="form_list"><label class="lable_title">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="sex" value="1">&nbsp;&nbsp;男&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="sex" value="2">&nbsp;&nbsp;女</div>
                            <div class="form_list"><label class="lable_title">手&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机</label><input class="form_input" type="text" name="phone"/></div>
                            <div class="form_list"><label class="lable_title">证件号码</label><input class="form_input" type="text" name="idCard"/></div>
                            <div class="form_list"><label class="lable_title">分配角色</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="type" value="1">&nbsp;&nbsp;超级管理员&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="type" value="0">&nbsp;&nbsp;普通管理员</div>
