...
<body>
 <div id="content"> <!-- Content start -->
                ...
                <div class="row-fluid">
                    <div class="span12">
                         <div  class="daohanglink"style="">
                           ...
                           <span>商品类别管理</span>
                            <a href="${ctx}/itemCat_addItemCat.do" class="label label-warning" style="float:right; margin:8px;">添加</a>
                         </div>
                        <div class="well brown">
                            <div class="well-content" style="border:0px;">
                                <table class="table table-striped table-bordered table-hover datatable">
                                    ...
                                    <tbody>
                                     <c:forEach items="${pagers.datas}" var="item_cat" varStatus="l">
                                        <tr>
                                            <td align="center">	${l.index+1 }</td>
                                            <td>${item_cat.cname}</td>
                                            <td>￥${item_cat.price}</td>
                                            <td><img src="${item_cat.image}" style="height: 100px;width: 100px"></td>
                                            <td>${item_cat.num}</td>
                                             <td> <%--<a class="btn"  href="${ctx}/itemCat_delItemCat.do?itemCatId=${item_cat.cid}" title="删除"><i class="icon-trash"></i></a> --%>
                                              <a class="btn"  href="${ctx}/itemCat_updateItemCat.do?itemCatId=${item_cat.cid}" title="修改"><i class="icon-inbox"></i></a></td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
      ...
      <pg:pager  url="${ctx}/itemCat_itemCatList.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
