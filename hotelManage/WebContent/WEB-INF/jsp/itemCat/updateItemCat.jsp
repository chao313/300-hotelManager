                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <div class="well brown">
                         <form action="itemCat_ItemCatUpdate.do"  method="post" enctype="multipart/form-data">
                            <div class="form_list"><label class="lable_title">类别名称</label>
                            <input class="form_input" name="cname" type="text" value="${item_cat.cname}"/></div>
                             <input type="hidden" name="cid"  value="${item_cat.cid}"/>
                            <div class="form_list"><label class="lable_title">价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格</label>
                            <input class="form_input" name="price" type="text" value="${item_cat.price }"/></div>
                            <div class="form_list"><label class="lable_title">图&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;片</label>
                           <input class="form_input" type="file" name="file" id="" value="${item_cat.image }"/></div>
                            <div class="form_list"><label class="lable_title">剩余数量</label>
                            <input class="form_input" name="num" type="text" value="${item_cat.num }"/>
                            </div>
